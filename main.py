...
parser.add_argument('--resume_epoch', type=int, default=30, metavar='N',
...
parser.add_argument('--num_c', type=int, default=2,
                    help='use different number of classifiers')
...
def main():
    ...
    # solver = DANNS(args, source=args.source, target=args.target, learning_rate=args.lr, batch_size=args.batch_size,
    ...
    solver = Solver(args, source=args.source, target=args.target, learning_rate=args.lr, batch_size=args.batch_size,
                    optimizer=args.optimizer, num_k=args.num_k, all_use=args.all_use,
                    checkpoint_dir=args.checkpoint_dir,
                    save_epoch=args.save_epoch, num_c=args.num_c)
    record_num = 0
